...
class GetIdentifiersResponse(BaseModel):
    """
    ...
    identifiers: Optional[List[IdentifierObject]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "identifiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifiers": [IdentifierObject.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None
        })
