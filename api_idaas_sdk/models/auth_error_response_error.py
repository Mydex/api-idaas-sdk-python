...
class AuthErrorResponseError(BaseModel):
    """
    AuthErrorResponseError
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Access denied"]})
    reason: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["The token is invalid or expired"]})
